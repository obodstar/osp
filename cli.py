...
class Pinterest:
    ...
    def login(self):
        ...
        "suebkosim@gmail.com",
        "ssueb517@gmail.com",
        "zakijaki146@gmail.com",
        "oman6363123@gmail.com",
        "ssakri497@gmail.com",
        "utasueb@gmail.com",
        "belajarngoding63@gmail.com",
        "belajarngoding666@gmail.com",
        "asepsikasep63@gmail.com",
        ...
        table.add_column("sandi", justify="center", style="bold")
        table.add_column("korbanhack ㅤㅤ ㅤㅤㅤ ㅤ ㅤㅤㅤㅤㅤㅤㅤㅤ", justify="left")
        for index, email in enumerate(emails, start=1):
        	table.add_row(f"{index}", email)
...
class CreatePin:
    ...
    def get_photo(self):
        ...
        while True:
            try:
                directory = input("? Folder (contoh: /sdcard/pin ) : ")
